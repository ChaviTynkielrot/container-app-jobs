from project.update_user_attribute import *
...
def test_update_user_attribute_called_patch(mock_patch):
    update_user_attribute('access_token',"user_id","attribute_name", "attribute_value")
    mock_patch.assert_called_once_with("https://graph.microsoft.com/v1.0/users/user_id",
                                headers={
...
def test_remove_user_attribute(update_user_attribute):
    ...
    update_user_attribute.assert_called_once_with('access_token', 'user_id', 'attribute_name', None)